...
export default function DataCenterContent() {
  ...
  return (
    ...
    >
      <header className="dc-header">
        <a href="/" aria-label="MarocGPU home"><img src="/marocgpu-logo.svg" alt="MarocGPU" /><span className="brand-name">MarocGPU</span></a>
      ...
      <footer className="dc-footer">
        <a href="/"><img src="/marocgpu-logo.svg" alt="MarocGPU" /><span className="brand-name">MarocGPU</span></a>
